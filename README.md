...
| [Google CTF](https://github.com/google/google-ctf) ⭐ 5,027 \| 🐛 1 \| 🌐 Python \| 📅 2026-09-15                                                  | Source code of Google 2017, 2018 and 2019 CTF                                                                                               |
...
| [Modern Binary Exploitation - CSCI 4968](https://github.com/RPISEC/MBE) ⭐ 6,052 \| 🐛 11 \| 🌐 C \| 📅 2021-12-09                                      | RE challenges, you can download the files or download the VM created by RPISEC specifically for challenges, also links to their home page with tons of infosec lectures |
...
| [PEASS-ng (Privilege Escalation Awesome Scripts)](https://github.com/carlospolop/PEASS-ng) ⭐ 20,569 \| 🐛 2 \| 🌐 C# \| 📅 2026-09-24                                             | actively maintained privilege escalation enumeration scripts for Windows, Linux, and macOS                  |
...
| Name                                                                                                      | Description                                                                           |
| --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| [theHarvester](https://github.com/laramies/theHarvester) ⭐ 17,592 \| 🐛 9 \| 🌐 Python \| 📅 2026-09-21   | E-mail, subdomain, host and people-name harvester using public sources                |
...
| [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 22,489 \| 🐛 320 \| 🌐 Python \| 📅 2026-04-13    | Automated OSINT collection with 200+ modules and a web UI                             |
...
| [metagoofil](https://github.com/laramies/metagoofil) ⭐ 1,319 \| 🐛 19 \| 🌐 Python \| 📅 2024-03-21       | Extracts metadata from public documents (PDF, DOC, XLS) belonging to a target         |
| [Sherlock](https://github.com/sherlock-project/sherlock) ⭐ 92,588 \| 🐛 350 \| 🌐 Python \| 📅 2026-09-24 | Hunt usernames across 400+ social networks                                            |
| [Maigret](https://github.com/soxoj/maigret) ⭐ 37,942 \| 🐛 70 \| 🌐 Python \| 📅 2026-09-24               | Sherlock-style username enumeration across 3000+ sites with profile-data extraction   |
| [Holehe](https://github.com/megadose/holehe) ⭐ 14,990 \| 🐛 119 \| 🌐 Python \| 📅 2024-09-10             | Check if an email is used on 120+ sites via password-reset flows                      |
| [GHunt](https://github.com/mxrch/GHunt) ⭐ 19,601 \| 🐛 76 \| 🌐 Python \| 📅 2026-04-10                   | OSINT toolkit for investigating Google accounts (Gmail, Drive, Calendar exposure)     |
| [Blackbird](https://github.com/p1ngul1n0/blackbird) ⭐ 8,546 \| 🐛 15 \| 🌐 Python \| 📅 2025-07-13        | Fast username and email OSINT search across 600+ services                             |
| [h8mail](https://github.com/khast3x/h8mail) ⭐ 5,312 \| 🐛 39 \| 🌐 Python \| 📅 2023-08-15                | Email OSINT and breach-credential hunting (HIBP, Snusbase, Leak-Lookup integrations)  |
| [PhoneInfoga](https://github.com/sundowndev/phoneinfoga) ⭐ 17,968 \| 🐛 147 \| 🌐 Go \| 📅 2026-08-25     | Advanced OSINT framework for scanning international phone numbers                     |
| [Photon](https://github.com/s0md3v/Photon) ⭐ 13,235 \| 🐛 60 \| 🌐 Python \| 📅 2026-09-04                | Fast web crawler that extracts URLs, emails, secrets, and intel for recon             |
| [Amass](https://github.com/owasp-amass/amass) ⭐ 15,216 \| 🐛 243 \| 🌐 Go \| 📅 2026-07-19                | OWASP project for in-depth attack-surface mapping and external asset discovery        |
| [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,500 \| 🐛 6 \| 🌐 Go \| 📅 2026-09-24     | Fast passive subdomain enumeration using public sources                               |
...
| [reconFTW](https://github.com/six2dez/reconftw) ⭐ 8,142 \| 🐛 1 \| 🌐 Shell \| 📅 2026-09-22              | End-to-end recon automation chaining 50+ tools for subdomains, vulns, and OSINT       |
| [IntelOwl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,727 \| 🐛 77 \| 🌐 Python \| 📅 2026-09-23    | OSINT solution that aggregates 100+ analyzers (threat intel, malware, observables)    |
...
| Name                                                                                                                                                | Description                                                                                                                        |
| --------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| [Garak](https://github.com/leondz/garak) ⭐ 9,349 \| 🐛 460 \| 🌐 Python \| 📅 2026-09-16                                                            | Most mature open-source LLM vulnerability scanner. Probes for prompt injection, jailbreaks, data leakage, hallucination, toxicity. |
...
| [Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 25,424 \| 🐛 643 \| 🌐 TypeScript \| 📅 2026-09-24                                            | LLM red-team + eval framework with 100+ attack types.                                                                              |
| [DeepTeam](https://github.com/confident-ai/deepteam) ⭐ 2,947 \| 🐛 76 \| 🌐 Python \| 📅 2026-09-21                                                 | Red-team framework mapped to OWASP LLM Top 10; 50+ vulnerabilities, 20+ adversarial methods.                                       |
| [LLMFuzzer](https://github.com/mnns/LLMFuzzer) ⭐ 378 \| 🐛 3 \| 🌐 Python \| 📅 2024-02-12                                                          | Fuzzing framework specifically for LLM integrations.                                                                               |
...
| [AI Exploits (Protect AI)](https://github.com/protectai/ai-exploits) ⭐ 1,745 \| 🐛 3 \| 🌐 Python \| 📅 2024-10-23                                  | Collection of real, working exploits for vulnerabilities found in AI/ML tools and platforms.                                       |
...
| Name                                                                                                                          | Description                                                             |
| ----------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| [corca-ai/awesome-llm-security](https://github.com/corca-ai/awesome-llm-security) ⭐ 1,702 \| 🐛 232 \| 📅 2025-08-20          | Most-starred LLM security awesome list.                                 |
...
| [jiep/offensive-ai-compilation](https://github.com/jiep/offensive-ai-compilation) ⭐ 1,428 \| 🐛 5 \| 🌐 HTML \| 📅 2026-09-14 | Offense-oriented curation: AI-powered attacks, plus attacks against AI. |
...
| [OWASP Juice Shop](https://github.com/juice-shop/juice-shop) ⭐ 13,943 \| 🐛 9 \| 🌐 TypeScript \| 📅 2026-09-23                           | covers the OWASP top 10 vulns                                                              |
| [WebGoat: A deliberately insecure Web Application](https://github.com/WebGoat/WebGoat) ⭐ 9,352 \| 🐛 35 \| 🌐 JavaScript \| 📅 2026-09-24 | maintained by OWASP and designed to to teach web app security                              |
...
| [Metasploitable3](https://github.com/rapid7/metasploitable3) ⭐ 5,715 \| 🐛 74 \| 🌐 HTML \| 📅 2025-02-13 \[[Installation](https://github.com/rapid7/metasploitable3/blob/master/README.md) ⭐ 5,715 \| 🐛 74 \| 🌐 HTML \| 📅 2025-02-13] | the third installation of this vulnerable OS                 |
...
| [Docker for pentest](https://github.com/aaaguirrep/pentest) ⭐ 769 \| 🐛 3 \| 🌐 Dockerfile \| 📅 2022-03-11 | Image with the more used tools to create a pentest environment easily and quickly. |
