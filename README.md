...
| [HTB Writeups](https://github.com/momenbasel/htb-writeups) ⭐ 227 \| 🐛 0 \| 🌐 HTML \| 📅 2026-07-18                                              | The most comprehensive Hack The Box writeup collection with 500+ machines, 400+ challenges, ProLabs, Sherlocks, CTF events, and cheatsheets |
...
| [Modern Binary Exploitation - CSCI 4968](https://github.com/RPISEC/MBE) ⭐ 6,032 \| 🐛 11 \| 🌐 C \| 📅 2021-12-09                                      | RE challenges, you can download the files or download the VM created by RPISEC specifically for challenges, also links to their home page with tons of infosec lectures |
...
| [Reverse engineering reading list](https://github.com/onethawt/reverseengineering-reading-list/blob/master/README.md) ⭐ 2,715 \| 🐛 1 \| 📅 2023-05-02 | a github collection of RE tools and books                                                                                                                               |
...
| [Linux Privilege Escalation Check Script](https://github.com/sleventyeleven/linuxprivchecker) ⭐ 1,832 \| 🐛 1 \| 🌐 Python \| 📅 2022-01-31                                       | a simple linux PE check script                                                                              |
...
| [PEASS-ng (Privilege Escalation Awesome Scripts)](https://github.com/carlospolop/PEASS-ng) ⭐ 20,376 \| 🐛 0 \| 🌐 C# \| 📅 2026-08-24                                             | actively maintained privilege escalation enumeration scripts for Windows, Linux, and macOS                  |
...
| Name                                                                                                      | Description                                                                           |
| --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| [theHarvester](https://github.com/laramies/theHarvester) ⭐ 17,194 \| 🐛 8 \| 🌐 Python \| 📅 2026-08-25   | E-mail, subdomain, host and people-name harvester using public sources                |
...
| [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 21,420 \| 🐛 311 \| 🌐 Python \| 📅 2026-04-13    | Automated OSINT collection with 200+ modules and a web UI                             |
...
| [github-dorks](https://github.com/techgaun/github-dorks) ⭐ 3,269 \| 🐛 11 \| 🌐 Python \| 📅 2025-10-05   | CLI tool to scan GitHub repos/orgs for sensitive information leaks                    |
...
| [Sherlock](https://github.com/sherlock-project/sherlock) ⭐ 90,306 \| 🐛 333 \| 🌐 Python \| 📅 2026-08-25 | Hunt usernames across 400+ social networks                                            |
| [Maigret](https://github.com/soxoj/maigret) ⭐ 37,052 \| 🐛 23 \| 🌐 Python \| 📅 2026-08-25               | Sherlock-style username enumeration across 3000+ sites with profile-data extraction   |
| [Holehe](https://github.com/megadose/holehe) ⭐ 14,210 \| 🐛 114 \| 🌐 Python \| 📅 2024-09-10             | Check if an email is used on 120+ sites via password-reset flows                      |
| [GHunt](https://github.com/mxrch/GHunt) ⭐ 19,419 \| 🐛 74 \| 🌐 Python \| 📅 2026-04-10                   | OSINT toolkit for investigating Google accounts (Gmail, Drive, Calendar exposure)     |
| [Blackbird](https://github.com/p1ngul1n0/blackbird) ⭐ 7,854 \| 🐛 19 \| 🌐 Python \| 📅 2025-07-13        | Fast username and email OSINT search across 600+ services                             |
...
| [PhoneInfoga](https://github.com/sundowndev/phoneinfoga) ⭐ 17,634 \| 🐛 123 \| 🌐 Go \| 📅 2026-08-25     | Advanced OSINT framework for scanning international phone numbers                     |
| [Photon](https://github.com/s0md3v/Photon) ⭐ 13,143 \| 🐛 59 \| 🌐 Python \| 📅 2026-08-07                | Fast web crawler that extracts URLs, emails, secrets, and intel for recon             |
| [Amass](https://github.com/owasp-amass/amass) ⭐ 15,042 \| 🐛 237 \| 🌐 Go \| 📅 2026-07-19                | OWASP project for in-depth attack-surface mapping and external asset discovery        |
| [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,308 \| 🐛 2 \| 🌐 Go \| 📅 2026-08-22     | Fast passive subdomain enumeration using public sources                               |
...
| [reconFTW](https://github.com/six2dez/reconftw) ⭐ 8,023 \| 🐛 2 \| 🌐 Shell \| 📅 2026-08-25              | End-to-end recon automation chaining 50+ tools for subdomains, vulns, and OSINT       |
| [IntelOwl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,682 \| 🐛 78 \| 🌐 Python \| 📅 2026-08-25    | OSINT solution that aggregates 100+ analyzers (threat intel, malware, observables)    |
...
| [Malware Analysis - CSCI 4976](https://github.com/RPISEC/Malware/blob/master/README.md) ⭐ 4,057 \| 🐛 1 \| 📅 2022-08-26 | another class from the folks at RPISEC, quality content |
...
| Name                                                                                                                                                | Description                                                                                                                        |
| --------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| [Garak](https://github.com/leondz/garak) ⭐ 9,032 \| 🐛 402 \| 🌐 Python \| 📅 2026-08-25                                                            | Most mature open-source LLM vulnerability scanner. Probes for prompt injection, jailbreaks, data leakage, hallucination, toxicity. |
...
| [Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,569 \| 🐛 516 \| 🌐 TypeScript \| 📅 2026-08-25                                            | LLM red-team + eval framework with 100+ attack types.                                                                              |
| [DeepTeam](https://github.com/confident-ai/deepteam) ⭐ 2,621 \| 🐛 59 \| 🌐 Python \| 📅 2026-08-21                                                 | Red-team framework mapped to OWASP LLM Top 10; 50+ vulnerabilities, 20+ adversarial methods.                                       |
...
| [Adversarial Robustness Toolbox (ART)](https://github.com/Trusted-AI/adversarial-robustness-toolbox) ⭐ 6,202 \| 🐛 19 \| 🌐 Python \| 📅 2025-12-12 | Linux Foundation library covering evasion, poisoning, extraction, and inference attacks across all major ML frameworks.            |
...
| [Indirect Prompt Injection (Greshake et al.)](https://github.com/greshake/llm-security) ⭐ 2,131 \| 🐛 1 \| 🌐 Jupyter Notebook \| 📅 2025-07-17 | Canonical research repo for indirect prompt injection.                                       |
...
| Name                                                                                                                          | Description                                                             |
| ----------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| [corca-ai/awesome-llm-security](https://github.com/corca-ai/awesome-llm-security) ⭐ 1,686 \| 🐛 198 \| 📅 2025-08-20          | Most-starred LLM security awesome list.                                 |
...
| [OWASP Juice Shop](https://github.com/juice-shop/juice-shop) ⭐ 13,718 \| 🐛 6 \| 🌐 TypeScript \| 📅 2026-08-24                           | covers the OWASP top 10 vulns                                                              |
| [WebGoat: A deliberately insecure Web Application](https://github.com/WebGoat/WebGoat) ⭐ 9,292 \| 🐛 39 \| 🌐 JavaScript \| 📅 2026-08-24 | maintained by OWASP and designed to to teach web app security                              |
...
| [Metasploitable3](https://github.com/rapid7/metasploitable3) ⭐ 5,680 \| 🐛 74 \| 🌐 HTML \| 📅 2025-02-13 \[[Installation](https://github.com/rapid7/metasploitable3/blob/master/README.md) ⭐ 5,680 \| 🐛 74 \| 🌐 HTML \| 📅 2025-02-13] | the third installation of this vulnerable OS                 |
