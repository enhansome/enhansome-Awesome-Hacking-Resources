...
| [Google CTF](https://github.com/google/google-ctf) ⭐ 5,008 \| 🐛 1 \| 🌐 Python \| 📅 2026-02-11                                                  | Source code of Google 2017, 2018 and 2019 CTF                                                                                               |
...
| [HTB Writeups](https://github.com/momenbasel/htb-writeups) ⭐ 225 \| 🐛 0 \| 🌐 HTML \| 📅 2026-07-18                                              | The most comprehensive Hack The Box writeup collection with 500+ machines, 400+ challenges, ProLabs, Sherlocks, CTF events, and cheatsheets |
...
| [Modern Binary Exploitation - CSCI 4968](https://github.com/RPISEC/MBE) ⭐ 6,031 \| 🐛 11 \| 🌐 C \| 📅 2021-12-09                                      | RE challenges, you can download the files or download the VM created by RPISEC specifically for challenges, also links to their home page with tons of infosec lectures |
...
| [Reverse engineering reading list](https://github.com/onethawt/reverseengineering-reading-list/blob/master/README.md) ⭐ 2,713 \| 🐛 1 \| 📅 2023-05-02 | a github collection of RE tools and books                                                                                                                               |
...
| [Linux Privilege Escalation Check Script](https://github.com/sleventyeleven/linuxprivchecker) ⭐ 1,830 \| 🐛 1 \| 🌐 Python \| 📅 2022-01-31                                       | a simple linux PE check script                                                                              |
...
| [PEASS-ng (Privilege Escalation Awesome Scripts)](https://github.com/carlospolop/PEASS-ng) ⭐ 20,361 \| 🐛 2 \| 🌐 C# \| 📅 2026-08-17                                             | actively maintained privilege escalation enumeration scripts for Windows, Linux, and macOS                  |
...
| Name                                                                                                      | Description                                                                           |
| --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| [theHarvester](https://github.com/laramies/theHarvester) ⭐ 17,174 \| 🐛 8 \| 🌐 Python \| 📅 2026-08-22   | E-mail, subdomain, host and people-name harvester using public sources                |
...
| [Recon-ng](https://github.com/lanmaster53/recon-ng) ⭐ 5,865 \| 🐛 38 \| 🌐 Python \| 📅 2024-11-01        | Full-featured web reconnaissance framework written in Python                          |
| [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 21,372 \| 🐛 310 \| 🌐 Python \| 📅 2026-04-13    | Automated OSINT collection with 200+ modules and a web UI                             |
...
| [Sherlock](https://github.com/sherlock-project/sherlock) ⭐ 90,078 \| 🐛 333 \| 🌐 Python \| 📅 2026-08-23 | Hunt usernames across 400+ social networks                                            |
| [Maigret](https://github.com/soxoj/maigret) ⭐ 36,984 \| 🐛 20 \| 🌐 Python \| 📅 2026-08-23               | Sherlock-style username enumeration across 3000+ sites with profile-data extraction   |
| [Holehe](https://github.com/megadose/holehe) ⭐ 14,070 \| 🐛 113 \| 🌐 Python \| 📅 2024-09-10             | Check if an email is used on 120+ sites via password-reset flows                      |
| [GHunt](https://github.com/mxrch/GHunt) ⭐ 19,406 \| 🐛 74 \| 🌐 Python \| 📅 2026-04-10                   | OSINT toolkit for investigating Google accounts (Gmail, Drive, Calendar exposure)     |
| [Blackbird](https://github.com/p1ngul1n0/blackbird) ⭐ 7,821 \| 🐛 19 \| 🌐 Python \| 📅 2025-07-13        | Fast username and email OSINT search across 600+ services                             |
| [h8mail](https://github.com/khast3x/h8mail) ⭐ 5,269 \| 🐛 39 \| 🌐 Python \| 📅 2023-08-15                | Email OSINT and breach-credential hunting (HIBP, Snusbase, Leak-Lookup integrations)  |
| [PhoneInfoga](https://github.com/sundowndev/phoneinfoga) ⭐ 17,609 \| 🐛 123 \| 🌐 Go \| 📅 2026-01-06     | Advanced OSINT framework for scanning international phone numbers                     |
| [Photon](https://github.com/s0md3v/Photon) ⭐ 13,135 \| 🐛 59 \| 🌐 Python \| 📅 2026-08-07                | Fast web crawler that extracts URLs, emails, secrets, and intel for recon             |
| [Amass](https://github.com/owasp-amass/amass) ⭐ 15,027 \| 🐛 237 \| 🌐 Go \| 📅 2026-07-19                | OWASP project for in-depth attack-surface mapping and external asset discovery        |
| [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,279 \| 🐛 1 \| 🌐 Go \| 📅 2026-08-22     | Fast passive subdomain enumeration using public sources                               |
...
| [reconFTW](https://github.com/six2dez/reconftw) ⭐ 8,019 \| 🐛 3 \| 🌐 Shell \| 📅 2026-08-20              | End-to-end recon automation chaining 50+ tools for subdomains, vulns, and OSINT       |
| [IntelOwl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,680 \| 🐛 74 \| 🌐 Python \| 📅 2026-08-20    | OSINT solution that aggregates 100+ analyzers (threat intel, malware, observables)    |
...
| Name                                                                                                                                                | Description                                                                                                                        |
| --------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| [Garak](https://github.com/leondz/garak) ⭐ 8,962 \| 🐛 404 \| 🌐 Python \| 📅 2026-08-21                                                            | Most mature open-source LLM vulnerability scanner. Probes for prompt injection, jailbreaks, data leakage, hallucination, toxicity. |
...
| [Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,492 \| 🐛 519 \| 🌐 TypeScript \| 📅 2026-08-23                                            | LLM red-team + eval framework with 100+ attack types.                                                                              |
| [DeepTeam](https://github.com/confident-ai/deepteam) ⭐ 2,611 \| 🐛 58 \| 🌐 Python \| 📅 2026-08-21                                                 | Red-team framework mapped to OWASP LLM Top 10; 50+ vulnerabilities, 20+ adversarial methods.                                       |
...
| [Adversarial Robustness Toolbox (ART)](https://github.com/Trusted-AI/adversarial-robustness-toolbox) ⭐ 6,194 \| 🐛 19 \| 🌐 Python \| 📅 2025-12-12 | Linux Foundation library covering evasion, poisoning, extraction, and inference attacks across all major ML frameworks.            |
...
| [Indirect Prompt Injection (Greshake et al.)](https://github.com/greshake/llm-security) ⭐ 2,129 \| 🐛 1 \| 🌐 Jupyter Notebook \| 📅 2025-07-17 | Canonical research repo for indirect prompt injection.                                       |
...
| Name                                                                                                                          | Description                                                             |
| ----------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| [corca-ai/awesome-llm-security](https://github.com/corca-ai/awesome-llm-security) ⭐ 1,685 \| 🐛 196 \| 📅 2025-08-20          | Most-starred LLM security awesome list.                                 |
...
| [OWASP Juice Shop](https://github.com/juice-shop/juice-shop) ⭐ 13,704 \| 🐛 4 \| 🌐 TypeScript \| 📅 2026-08-21                           | covers the OWASP top 10 vulns                                                              |
| [WebGoat: A deliberately insecure Web Application](https://github.com/WebGoat/WebGoat) ⭐ 9,288 \| 🐛 36 \| 🌐 JavaScript \| 📅 2026-08-14 | maintained by OWASP and designed to to teach web app security                              |
...
| [Metasploitable3](https://github.com/rapid7/metasploitable3) ⭐ 5,677 \| 🐛 74 \| 🌐 HTML \| 📅 2025-02-13 \[[Installation](https://github.com/rapid7/metasploitable3/blob/master/README.md) ⭐ 5,677 \| 🐛 74 \| 🌐 HTML \| 📅 2025-02-13] | the third installation of this vulnerable OS                 |
...
| [Docker for pentest](https://github.com/aaaguirrep/pentest) ⭐ 769 \| 🐛 2 \| 🌐 Dockerfile \| 📅 2022-03-11 | Image with the more used tools to create a pentest environment easily and quickly. |
