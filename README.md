...
| [Google CTF](https://github.com/google/google-ctf) ⭐ 5,019 \| 🐛 1 \| 🌐 Python \| 📅 2026-02-11                                                  | Source code of Google 2017, 2018 and 2019 CTF                                                                                               |
...
| [Windows / Linux Local Privilege Escalation Workshop](https://github.com/sagishahar/lpeworkshop) ⭐ 2,128 \| 🐛 0 \| 🌐 Batchfile \| 📅 2022-10-09 | Practice your Linux and Windows privilege escalation                                                                                        |
...
| [HTB Writeups](https://github.com/momenbasel/htb-writeups) ⭐ 235 \| 🐛 0 \| 🌐 HTML \| 📅 2026-07-18                                              | The most comprehensive Hack The Box writeup collection with 500+ machines, 400+ challenges, ProLabs, Sherlocks, CTF events, and cheatsheets |
...
| [Modern Binary Exploitation - CSCI 4968](https://github.com/RPISEC/MBE) ⭐ 6,042 \| 🐛 11 \| 🌐 C \| 📅 2021-12-09                                      | RE challenges, you can download the files or download the VM created by RPISEC specifically for challenges, also links to their home page with tons of infosec lectures |
...
| [Linux Privilege Escalation Check Script](https://github.com/sleventyeleven/linuxprivchecker) ⭐ 1,839 \| 🐛 0 \| 🌐 Python \| 📅 2022-01-31                                       | a simple linux PE check script                                                                              |
...
| [PEASS-ng (Privilege Escalation Awesome Scripts)](https://github.com/carlospolop/PEASS-ng) ⭐ 20,419 \| 🐛 1 \| 🌐 C# \| 📅 2026-09-01                                             | actively maintained privilege escalation enumeration scripts for Windows, Linux, and macOS                  |
...
| Name                                                                                                      | Description                                                                           |
| --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| [theHarvester](https://github.com/laramies/theHarvester) ⭐ 17,267 \| 🐛 9 \| 🌐 Python \| 📅 2026-09-02   | E-mail, subdomain, host and people-name harvester using public sources                |
...
| [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 21,691 \| 🐛 318 \| 🌐 Python \| 📅 2026-04-13    | Automated OSINT collection with 200+ modules and a web UI                             |
...
| [Sherlock](https://github.com/sherlock-project/sherlock) ⭐ 90,862 \| 🐛 340 \| 🌐 Python \| 📅 2026-09-02 | Hunt usernames across 400+ social networks                                            |
| [Maigret](https://github.com/soxoj/maigret) ⭐ 37,258 \| 🐛 25 \| 🌐 Python \| 📅 2026-09-02               | Sherlock-style username enumeration across 3000+ sites with profile-data extraction   |
| [Holehe](https://github.com/megadose/holehe) ⭐ 14,593 \| 🐛 116 \| 🌐 Python \| 📅 2024-09-10             | Check if an email is used on 120+ sites via password-reset flows                      |
| [GHunt](https://github.com/mxrch/GHunt) ⭐ 19,490 \| 🐛 75 \| 🌐 Python \| 📅 2026-04-10                   | OSINT toolkit for investigating Google accounts (Gmail, Drive, Calendar exposure)     |
| [Blackbird](https://github.com/p1ngul1n0/blackbird) ⭐ 7,927 \| 🐛 15 \| 🌐 Python \| 📅 2025-07-13        | Fast username and email OSINT search across 600+ services                             |
| [h8mail](https://github.com/khast3x/h8mail) ⭐ 5,276 \| 🐛 39 \| 🌐 Python \| 📅 2023-08-15                | Email OSINT and breach-credential hunting (HIBP, Snusbase, Leak-Lookup integrations)  |
| [PhoneInfoga](https://github.com/sundowndev/phoneinfoga) ⭐ 17,750 \| 🐛 131 \| 🌐 Go \| 📅 2026-08-25     | Advanced OSINT framework for scanning international phone numbers                     |
| [Photon](https://github.com/s0md3v/Photon) ⭐ 13,160 \| 🐛 59 \| 🌐 Python \| 📅 2026-08-07                | Fast web crawler that extracts URLs, emails, secrets, and intel for recon             |
| [Amass](https://github.com/owasp-amass/amass) ⭐ 15,087 \| 🐛 242 \| 🌐 Go \| 📅 2026-07-19                | OWASP project for in-depth attack-surface mapping and external asset discovery        |
| [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,363 \| 🐛 3 \| 🌐 Go \| 📅 2026-09-02     | Fast passive subdomain enumeration using public sources                               |
| [cloud\_enum](https://github.com/initstring/cloud_enum) ⭐ 2,137 \| 🐛 0 \| 🌐 Python \| 📅 2026-07-09     | Enumerate public resources in AWS, Azure, and GCP for a target keyword                |
| [reconFTW](https://github.com/six2dez/reconftw) ⭐ 8,053 \| 🐛 3 \| 🌐 Shell \| 📅 2026-09-01              | End-to-end recon automation chaining 50+ tools for subdomains, vulns, and OSINT       |
| [IntelOwl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,694 \| 🐛 75 \| 🌐 Python \| 📅 2026-09-02    | OSINT solution that aggregates 100+ analyzers (threat intel, malware, observables)    |
...
| [Malware Analysis - CSCI 4976](https://github.com/RPISEC/Malware/blob/master/README.md) ⭐ 4,066 \| 🐛 1 \| 📅 2022-08-26 | another class from the folks at RPISEC, quality content |
...
| Name                                                                                                                                                | Description                                                                                                                        |
| --------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| [Garak](https://github.com/leondz/garak) ⭐ 9,094 \| 🐛 415 \| 🌐 Python \| 📅 2026-08-25                                                            | Most mature open-source LLM vulnerability scanner. Probes for prompt injection, jailbreaks, data leakage, hallucination, toxicity. |
...
| [Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,767 \| 🐛 573 \| 🌐 TypeScript \| 📅 2026-09-02                                            | LLM red-team + eval framework with 100+ attack types.                                                                              |
| [DeepTeam](https://github.com/confident-ai/deepteam) ⭐ 2,651 \| 🐛 59 \| 🌐 Python \| 📅 2026-08-21                                                 | Red-team framework mapped to OWASP LLM Top 10; 50+ vulnerabilities, 20+ adversarial methods.                                       |
| [LLMFuzzer](https://github.com/mnns/LLMFuzzer) ⭐ 380 \| 🐛 3 \| 🌐 Python \| 📅 2024-02-12                                                          | Fuzzing framework specifically for LLM integrations.                                                                               |
| [promptmap](https://github.com/utkusen/promptmap) ⭐ 1,263 \| 🐛 4 \| 🌐 Python \| 📅 2025-12-01                                                     | Prompt-injection vulnerability scanner.                                                                                            |
| [Adversarial Robustness Toolbox (ART)](https://github.com/Trusted-AI/adversarial-robustness-toolbox) ⭐ 6,213 \| 🐛 23 \| 🌐 Python \| 📅 2025-12-12 | Linux Foundation library covering evasion, poisoning, extraction, and inference attacks across all major ML frameworks.            |
...
| [Indirect Prompt Injection (Greshake et al.)](https://github.com/greshake/llm-security) ⭐ 2,135 \| 🐛 1 \| 🌐 Jupyter Notebook \| 📅 2025-07-17 | Canonical research repo for indirect prompt injection.                                       |
...
| Name                                                                                                                          | Description                                                             |
| ----------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| [corca-ai/awesome-llm-security](https://github.com/corca-ai/awesome-llm-security) ⭐ 1,690 \| 🐛 201 \| 📅 2025-08-20          | Most-starred LLM security awesome list.                                 |
| [PromptLabs/Prompt-Hacking-Resources](https://github.com/PromptLabs/Prompt-Hacking-Resources) ⭐ 719 \| 🐛 2 \| 📅 2026-07-30  | Focused specifically on red teaming, jailbreaks, prompt injection.      |
| [jiep/offensive-ai-compilation](https://github.com/jiep/offensive-ai-compilation) ⭐ 1,422 \| 🐛 7 \| 🌐 HTML \| 📅 2026-08-01 | Offense-oriented curation: AI-powered attacks, plus attacks against AI. |
...
| [OWASP Juice Shop](https://github.com/juice-shop/juice-shop) ⭐ 13,771 \| 🐛 7 \| 🌐 TypeScript \| 📅 2026-09-02                           | covers the OWASP top 10 vulns                                                              |
| [WebGoat: A deliberately insecure Web Application](https://github.com/WebGoat/WebGoat) ⭐ 9,318 \| 🐛 40 \| 🌐 JavaScript \| 📅 2026-08-31 | maintained by OWASP and designed to to teach web app security                              |
...
| [Metasploitable3](https://github.com/rapid7/metasploitable3) ⭐ 5,694 \| 🐛 74 \| 🌐 HTML \| 📅 2025-02-13 \[[Installation](https://github.com/rapid7/metasploitable3/blob/master/README.md) ⭐ 5,694 \| 🐛 74 \| 🌐 HTML \| 📅 2025-02-13] | the third installation of this vulnerable OS                 |
