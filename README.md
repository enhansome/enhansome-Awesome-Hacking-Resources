...
| [Google CTF](https://github.com/google/google-ctf) ⭐ 5,023 \| 🐛 1 \| 🌐 Python \| 📅 2026-02-11                                                  | Source code of Google 2017, 2018 and 2019 CTF                                                                                               |
...
| [HTB Writeups](https://github.com/momenbasel/htb-writeups) ⭐ 244 \| 🐛 0 \| 🌐 HTML \| 📅 2026-07-18                                              | The most comprehensive Hack The Box writeup collection with 500+ machines, 400+ challenges, ProLabs, Sherlocks, CTF events, and cheatsheets |
...
| [Modern Binary Exploitation - CSCI 4968](https://github.com/RPISEC/MBE) ⭐ 6,047 \| 🐛 11 \| 🌐 C \| 📅 2021-12-09                                      | RE challenges, you can download the files or download the VM created by RPISEC specifically for challenges, also links to their home page with tons of infosec lectures |
...
| [Reverse engineering reading list](https://github.com/onethawt/reverseengineering-reading-list/blob/master/README.md) ⭐ 2,721 \| 🐛 1 \| 📅 2023-05-02 | a github collection of RE tools and books                                                                                                                               |
...
| [PEASS-ng (Privilege Escalation Awesome Scripts)](https://github.com/carlospolop/PEASS-ng) ⭐ 20,514 \| 🐛 1 \| 🌐 C# \| 📅 2026-09-12                                             | actively maintained privilege escalation enumeration scripts for Windows, Linux, and macOS                  |
...
| Name                                                                                                      | Description                                                                           |
| --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| [theHarvester](https://github.com/laramies/theHarvester) ⭐ 17,367 \| 🐛 6 \| 🌐 Python \| 📅 2026-09-10   | E-mail, subdomain, host and people-name harvester using public sources                |
...
| [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 22,084 \| 🐛 325 \| 🌐 Python \| 📅 2026-04-13    | Automated OSINT collection with 200+ modules and a web UI                             |
...
| [github-dorks](https://github.com/techgaun/github-dorks) ⭐ 3,277 \| 🐛 12 \| 🌐 Python \| 📅 2026-09-13   | CLI tool to scan GitHub repos/orgs for sensitive information leaks                    |
...
| [Sherlock](https://github.com/sherlock-project/sherlock) ⭐ 91,457 \| 🐛 342 \| 🌐 Python \| 📅 2026-09-13 | Hunt usernames across 400+ social networks                                            |
| [Maigret](https://github.com/soxoj/maigret) ⭐ 37,516 \| 🐛 61 \| 🌐 Python \| 📅 2026-09-13               | Sherlock-style username enumeration across 3000+ sites with profile-data extraction   |
| [Holehe](https://github.com/megadose/holehe) ⭐ 14,905 \| 🐛 117 \| 🌐 Python \| 📅 2024-09-10             | Check if an email is used on 120+ sites via password-reset flows                      |
| [GHunt](https://github.com/mxrch/GHunt) ⭐ 19,551 \| 🐛 76 \| 🌐 Python \| 📅 2026-04-10                   | OSINT toolkit for investigating Google accounts (Gmail, Drive, Calendar exposure)     |
| [Blackbird](https://github.com/p1ngul1n0/blackbird) ⭐ 8,086 \| 🐛 16 \| 🌐 Python \| 📅 2025-07-13        | Fast username and email OSINT search across 600+ services                             |
| [h8mail](https://github.com/khast3x/h8mail) ⭐ 5,295 \| 🐛 39 \| 🌐 Python \| 📅 2023-08-15                | Email OSINT and breach-credential hunting (HIBP, Snusbase, Leak-Lookup integrations)  |
| [PhoneInfoga](https://github.com/sundowndev/phoneinfoga) ⭐ 17,862 \| 🐛 142 \| 🌐 Go \| 📅 2026-08-25     | Advanced OSINT framework for scanning international phone numbers                     |
| [Photon](https://github.com/s0md3v/Photon) ⭐ 13,204 \| 🐛 61 \| 🌐 Python \| 📅 2026-09-04                | Fast web crawler that extracts URLs, emails, secrets, and intel for recon             |
| [Amass](https://github.com/owasp-amass/amass) ⭐ 15,154 \| 🐛 242 \| 🌐 Go \| 📅 2026-07-19                | OWASP project for in-depth attack-surface mapping and external asset discovery        |
| [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,423 \| 🐛 6 \| 🌐 Go \| 📅 2026-09-11     | Fast passive subdomain enumeration using public sources                               |
...
| [reconFTW](https://github.com/six2dez/reconftw) ⭐ 8,109 \| 🐛 7 \| 🌐 Shell \| 📅 2026-09-05              | End-to-end recon automation chaining 50+ tools for subdomains, vulns, and OSINT       |
| [IntelOwl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,714 \| 🐛 72 \| 🌐 Python \| 📅 2026-09-12    | OSINT solution that aggregates 100+ analyzers (threat intel, malware, observables)    |
...
| Name                                                                                                                                                | Description                                                                                                                        |
| --------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| [Garak](https://github.com/leondz/garak) ⭐ 9,226 \| 🐛 428 \| 🌐 Python \| 📅 2026-09-09                                                            | Most mature open-source LLM vulnerability scanner. Probes for prompt injection, jailbreaks, data leakage, hallucination, toxicity. |
...
| [Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 25,066 \| 🐛 655 \| 🌐 TypeScript \| 📅 2026-09-14                                            | LLM red-team + eval framework with 100+ attack types.                                                                              |
| [DeepTeam](https://github.com/confident-ai/deepteam) ⭐ 2,795 \| 🐛 64 \| 🌐 Python \| 📅 2026-08-21                                                 | Red-team framework mapped to OWASP LLM Top 10; 50+ vulnerabilities, 20+ adversarial methods.                                       |
| [LLMFuzzer](https://github.com/mnns/LLMFuzzer) ⭐ 380 \| 🐛 3 \| 🌐 Python \| 📅 2024-02-12                                                          | Fuzzing framework specifically for LLM integrations.                                                                               |
| [promptmap](https://github.com/utkusen/promptmap) ⭐ 1,267 \| 🐛 4 \| 🌐 Python \| 📅 2025-12-01                                                     | Prompt-injection vulnerability scanner.                                                                                            |
| [Adversarial Robustness Toolbox (ART)](https://github.com/Trusted-AI/adversarial-robustness-toolbox) ⭐ 6,222 \| 🐛 26 \| 🌐 Python \| 📅 2025-12-12 | Linux Foundation library covering evasion, poisoning, extraction, and inference attacks across all major ML frameworks.            |
...
| Name                                                                                                                          | Description                                                             |
| ----------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| [corca-ai/awesome-llm-security](https://github.com/corca-ai/awesome-llm-security) ⭐ 1,695 \| 🐛 216 \| 📅 2025-08-20          | Most-starred LLM security awesome list.                                 |
| [PromptLabs/Prompt-Hacking-Resources](https://github.com/PromptLabs/Prompt-Hacking-Resources) ⭐ 724 \| 🐛 2 \| 📅 2026-07-30  | Focused specifically on red teaming, jailbreaks, prompt injection.      |
| [jiep/offensive-ai-compilation](https://github.com/jiep/offensive-ai-compilation) ⭐ 1,425 \| 🐛 3 \| 🌐 HTML \| 📅 2026-09-13 | Offense-oriented curation: AI-powered attacks, plus attacks against AI. |
...
| [OWASP Juice Shop](https://github.com/juice-shop/juice-shop) ⭐ 13,856 \| 🐛 8 \| 🌐 TypeScript \| 📅 2026-09-09                           | covers the OWASP top 10 vulns                                                              |
| [WebGoat: A deliberately insecure Web Application](https://github.com/WebGoat/WebGoat) ⭐ 9,335 \| 🐛 38 \| 🌐 JavaScript \| 📅 2026-09-13 | maintained by OWASP and designed to to teach web app security                              |
...
| [Metasploitable3](https://github.com/rapid7/metasploitable3) ⭐ 5,704 \| 🐛 74 \| 🌐 HTML \| 📅 2025-02-13 \[[Installation](https://github.com/rapid7/metasploitable3/blob/master/README.md) ⭐ 5,704 \| 🐛 74 \| 🌐 HTML \| 📅 2025-02-13] | the third installation of this vulnerable OS                 |
