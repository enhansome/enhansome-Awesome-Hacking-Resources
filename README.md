...
| [HTB Writeups](https://github.com/momenbasel/htb-writeups) ⭐ 254 \| 🐛 0 \| 🌐 HTML \| 📅 2026-07-18                                              | The most comprehensive Hack The Box writeup collection with 500+ machines, 400+ challenges, ProLabs, Sherlocks, CTF events, and cheatsheets |
...
| [Reverse engineering reading list](https://github.com/onethawt/reverseengineering-reading-list/blob/master/README.md) ⭐ 2,727 \| 🐛 1 \| 📅 2023-05-02 | a github collection of RE tools and books                                                                                                                               |
...
| [Linux Privilege Escalation Check Script](https://github.com/sleventyeleven/linuxprivchecker) ⭐ 1,844 \| 🐛 0 \| 🌐 Python \| 📅 2022-01-31                                       | a simple linux PE check script                                                                              |
...
| [PEASS-ng (Privilege Escalation Awesome Scripts)](https://github.com/carlospolop/PEASS-ng) ⭐ 20,552 \| 🐛 1 \| 🌐 C# \| 📅 2026-09-19                                             | actively maintained privilege escalation enumeration scripts for Windows, Linux, and macOS                  |
...
| Name                                                                                                      | Description                                                                           |
| --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| [theHarvester](https://github.com/laramies/theHarvester) ⭐ 17,565 \| 🐛 7 \| 🌐 Python \| 📅 2026-09-19   | E-mail, subdomain, host and people-name harvester using public sources                |
...
| [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 22,429 \| 🐛 320 \| 🌐 Python \| 📅 2026-04-13    | Automated OSINT collection with 200+ modules and a web UI                             |
...
| [github-dorks](https://github.com/techgaun/github-dorks) ⭐ 3,283 \| 🐛 10 \| 🌐 Python \| 📅 2026-09-15   | CLI tool to scan GitHub repos/orgs for sensitive information leaks                    |
| [metagoofil](https://github.com/laramies/metagoofil) ⭐ 1,320 \| 🐛 19 \| 🌐 Python \| 📅 2024-03-21       | Extracts metadata from public documents (PDF, DOC, XLS) belonging to a target         |
| [Sherlock](https://github.com/sherlock-project/sherlock) ⭐ 92,292 \| 🐛 350 \| 🌐 Python \| 📅 2026-09-20 | Hunt usernames across 400+ social networks                                            |
| [Maigret](https://github.com/soxoj/maigret) ⭐ 37,854 \| 🐛 59 \| 🌐 Python \| 📅 2026-09-20               | Sherlock-style username enumeration across 3000+ sites with profile-data extraction   |
| [Holehe](https://github.com/megadose/holehe) ⭐ 14,958 \| 🐛 119 \| 🌐 Python \| 📅 2024-09-10             | Check if an email is used on 120+ sites via password-reset flows                      |
| [GHunt](https://github.com/mxrch/GHunt) ⭐ 19,582 \| 🐛 76 \| 🌐 Python \| 📅 2026-04-10                   | OSINT toolkit for investigating Google accounts (Gmail, Drive, Calendar exposure)     |
| [Blackbird](https://github.com/p1ngul1n0/blackbird) ⭐ 8,487 \| 🐛 16 \| 🌐 Python \| 📅 2025-07-13        | Fast username and email OSINT search across 600+ services                             |
| [h8mail](https://github.com/khast3x/h8mail) ⭐ 5,310 \| 🐛 39 \| 🌐 Python \| 📅 2023-08-15                | Email OSINT and breach-credential hunting (HIBP, Snusbase, Leak-Lookup integrations)  |
| [PhoneInfoga](https://github.com/sundowndev/phoneinfoga) ⭐ 17,925 \| 🐛 147 \| 🌐 Go \| 📅 2026-08-25     | Advanced OSINT framework for scanning international phone numbers                     |
| [Photon](https://github.com/s0md3v/Photon) ⭐ 13,218 \| 🐛 60 \| 🌐 Python \| 📅 2026-09-04                | Fast web crawler that extracts URLs, emails, secrets, and intel for recon             |
| [Amass](https://github.com/owasp-amass/amass) ⭐ 15,194 \| 🐛 242 \| 🌐 Go \| 📅 2026-07-19                | OWASP project for in-depth attack-surface mapping and external asset discovery        |
| [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,467 \| 🐛 4 \| 🌐 Go \| 📅 2026-09-16     | Fast passive subdomain enumeration using public sources                               |
...
| [reconFTW](https://github.com/six2dez/reconftw) ⭐ 8,126 \| 🐛 7 \| 🌐 Shell \| 📅 2026-09-05              | End-to-end recon automation chaining 50+ tools for subdomains, vulns, and OSINT       |
| [IntelOwl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,725 \| 🐛 69 \| 🌐 Python \| 📅 2026-09-18    | OSINT solution that aggregates 100+ analyzers (threat intel, malware, observables)    |
...
| Name                                                                                                                                                | Description                                                                                                                        |
| --------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| [Garak](https://github.com/leondz/garak) ⭐ 9,317 \| 🐛 450 \| 🌐 Python \| 📅 2026-09-16                                                            | Most mature open-source LLM vulnerability scanner. Probes for prompt injection, jailbreaks, data leakage, hallucination, toxicity. |
...
| [Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 25,314 \| 🐛 638 \| 🌐 TypeScript \| 📅 2026-09-20                                            | LLM red-team + eval framework with 100+ attack types.                                                                              |
| [DeepTeam](https://github.com/confident-ai/deepteam) ⭐ 2,882 \| 🐛 70 \| 🌐 Python \| 📅 2026-08-21                                                 | Red-team framework mapped to OWASP LLM Top 10; 50+ vulnerabilities, 20+ adversarial methods.                                       |
| [LLMFuzzer](https://github.com/mnns/LLMFuzzer) ⭐ 380 \| 🐛 3 \| 🌐 Python \| 📅 2024-02-12                                                          | Fuzzing framework specifically for LLM integrations.                                                                               |
| [promptmap](https://github.com/utkusen/promptmap) ⭐ 1,271 \| 🐛 4 \| 🌐 Python \| 📅 2025-12-01                                                     | Prompt-injection vulnerability scanner.                                                                                            |
| [Adversarial Robustness Toolbox (ART)](https://github.com/Trusted-AI/adversarial-robustness-toolbox) ⭐ 6,237 \| 🐛 28 \| 🌐 Python \| 📅 2025-12-12 | Linux Foundation library covering evasion, poisoning, extraction, and inference attacks across all major ML frameworks.            |
...
| [Indirect Prompt Injection (Greshake et al.)](https://github.com/greshake/llm-security) ⭐ 2,138 \| 🐛 1 \| 🌐 Jupyter Notebook \| 📅 2025-07-17 | Canonical research repo for indirect prompt injection.                                       |
...
| Name                                                                                                                          | Description                                                             |
| ----------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| [corca-ai/awesome-llm-security](https://github.com/corca-ai/awesome-llm-security) ⭐ 1,701 \| 🐛 226 \| 📅 2025-08-20          | Most-starred LLM security awesome list.                                 |
...
| [jiep/offensive-ai-compilation](https://github.com/jiep/offensive-ai-compilation) ⭐ 1,426 \| 🐛 4 \| 🌐 HTML \| 📅 2026-09-14 | Offense-oriented curation: AI-powered attacks, plus attacks against AI. |
...
| [OWASP Juice Shop](https://github.com/juice-shop/juice-shop) ⭐ 13,906 \| 🐛 14 \| 🌐 TypeScript \| 📅 2026-09-18                          | covers the OWASP top 10 vulns                                                              |
| [WebGoat: A deliberately insecure Web Application](https://github.com/WebGoat/WebGoat) ⭐ 9,344 \| 🐛 38 \| 🌐 JavaScript \| 📅 2026-09-17 | maintained by OWASP and designed to to teach web app security                              |
...
| [Metasploitable3](https://github.com/rapid7/metasploitable3) ⭐ 5,710 \| 🐛 74 \| 🌐 HTML \| 📅 2025-02-13 \[[Installation](https://github.com/rapid7/metasploitable3/blob/master/README.md) ⭐ 5,710 \| 🐛 74 \| 🌐 HTML \| 📅 2025-02-13] | the third installation of this vulnerable OS                 |
