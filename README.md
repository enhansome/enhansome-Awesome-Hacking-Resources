...
| [Google CTF](https://github.com/google/google-ctf) ⭐ 5,015 \| 🐛 1 \| 🌐 Python \| 📅 2026-02-11                                                  | Source code of Google 2017, 2018 and 2019 CTF                                                                                               |
...
| [Windows / Linux Local Privilege Escalation Workshop](https://github.com/sagishahar/lpeworkshop) ⭐ 2,126 \| 🐛 0 \| 🌐 Batchfile \| 📅 2022-10-09 | Practice your Linux and Windows privilege escalation                                                                                        |
...
| [HTB Writeups](https://github.com/momenbasel/htb-writeups) ⭐ 231 \| 🐛 0 \| 🌐 HTML \| 📅 2026-07-18                                              | The most comprehensive Hack The Box writeup collection with 500+ machines, 400+ challenges, ProLabs, Sherlocks, CTF events, and cheatsheets |
...
| Name                                                                                                                                                   | Description                                                                                                                                                             |
| ------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [A Course on Intermediate Level Linux Exploitation](https://github.com/nnamon/linux-exploitation-course) ⭐ 1,015 \| 🐛 4 \| 🌐 Python \| 📅 2020-08-24 | as the title says, this course isn't for beginners                                                                                                                      |
...
| [Modern Binary Exploitation - CSCI 4968](https://github.com/RPISEC/MBE) ⭐ 6,038 \| 🐛 11 \| 🌐 C \| 📅 2021-12-09                                      | RE challenges, you can download the files or download the VM created by RPISEC specifically for challenges, also links to their home page with tons of infosec lectures |
...
| [Reverse engineering reading list](https://github.com/onethawt/reverseengineering-reading-list/blob/master/README.md) ⭐ 2,718 \| 🐛 1 \| 📅 2023-05-02 | a github collection of RE tools and books                                                                                                                               |
...
| [Linux Privilege Escalation Check Script](https://github.com/sleventyeleven/linuxprivchecker) ⭐ 1,836 \| 🐛 1 \| 🌐 Python \| 📅 2022-01-31                                       | a simple linux PE check script                                                                              |
...
| [PEASS-ng (Privilege Escalation Awesome Scripts)](https://github.com/carlospolop/PEASS-ng) ⭐ 20,398 \| 🐛 0 \| 🌐 C# \| 📅 2026-08-29                                             | actively maintained privilege escalation enumeration scripts for Windows, Linux, and macOS                  |
...
| [Windows exploits, mostly precompiled.](https://github.com/abatchy17/WindowsExploits) ⭐ 1,936 \| 🐛 1 \| 🌐 Python \| 📅 2020-09-07                                               | precompiled windows exploits, could be useful for reverse engineering too                                   |
...
| [Windows privilege escalation checker](https://github.com/netbiosX/Checklists/blob/master/Windows-Privilege-Escalation.md) ⭐ 2,657 \| 🐛 1 \| 📅 2025-07-27                       | a list of topics that link to pentestlab.blog, all related to windows privilege escalation                  |
...
| Name                                                                                                      | Description                                                                           |
| --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| [theHarvester](https://github.com/laramies/theHarvester) ⭐ 17,231 \| 🐛 7 \| 🌐 Python \| 📅 2026-08-29   | E-mail, subdomain, host and people-name harvester using public sources                |
...
| [Recon-ng](https://github.com/lanmaster53/recon-ng) ⭐ 5,877 \| 🐛 38 \| 🌐 Python \| 📅 2024-11-01        | Full-featured web reconnaissance framework written in Python                          |
| [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 21,505 \| 🐛 315 \| 🌐 Python \| 📅 2026-04-13    | Automated OSINT collection with 200+ modules and a web UI                             |
...
| [github-dorks](https://github.com/techgaun/github-dorks) ⭐ 3,273 \| 🐛 11 \| 🌐 Python \| 📅 2026-08-29   | CLI tool to scan GitHub repos/orgs for sensitive information leaks                    |
| [metagoofil](https://github.com/laramies/metagoofil) ⭐ 1,316 \| 🐛 19 \| 🌐 Python \| 📅 2024-03-21       | Extracts metadata from public documents (PDF, DOC, XLS) belonging to a target         |
| [Sherlock](https://github.com/sherlock-project/sherlock) ⭐ 90,605 \| 🐛 337 \| 🌐 Python \| 📅 2026-08-29 | Hunt usernames across 400+ social networks                                            |
| [Maigret](https://github.com/soxoj/maigret) ⭐ 37,144 \| 🐛 28 \| 🌐 Python \| 📅 2026-08-29               | Sherlock-style username enumeration across 3000+ sites with profile-data extraction   |
| [Holehe](https://github.com/megadose/holehe) ⭐ 14,424 \| 🐛 115 \| 🌐 Python \| 📅 2024-09-10             | Check if an email is used on 120+ sites via password-reset flows                      |
| [GHunt](https://github.com/mxrch/GHunt) ⭐ 19,459 \| 🐛 75 \| 🌐 Python \| 📅 2026-04-10                   | OSINT toolkit for investigating Google accounts (Gmail, Drive, Calendar exposure)     |
| [Blackbird](https://github.com/p1ngul1n0/blackbird) ⭐ 7,894 \| 🐛 15 \| 🌐 Python \| 📅 2025-07-13        | Fast username and email OSINT search across 600+ services                             |
| [h8mail](https://github.com/khast3x/h8mail) ⭐ 5,274 \| 🐛 39 \| 🌐 Python \| 📅 2023-08-15                | Email OSINT and breach-credential hunting (HIBP, Snusbase, Leak-Lookup integrations)  |
| [PhoneInfoga](https://github.com/sundowndev/phoneinfoga) ⭐ 17,688 \| 🐛 127 \| 🌐 Go \| 📅 2026-08-25     | Advanced OSINT framework for scanning international phone numbers                     |
| [Photon](https://github.com/s0md3v/Photon) ⭐ 13,156 \| 🐛 59 \| 🌐 Python \| 📅 2026-08-07                | Fast web crawler that extracts URLs, emails, secrets, and intel for recon             |
| [Amass](https://github.com/owasp-amass/amass) ⭐ 15,059 \| 🐛 239 \| 🌐 Go \| 📅 2026-07-19                | OWASP project for in-depth attack-surface mapping and external asset discovery        |
| [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,332 \| 🐛 7 \| 🌐 Go \| 📅 2026-08-27     | Fast passive subdomain enumeration using public sources                               |
| [cloud\_enum](https://github.com/initstring/cloud_enum) ⭐ 2,134 \| 🐛 0 \| 🌐 Python \| 📅 2026-07-09     | Enumerate public resources in AWS, Azure, and GCP for a target keyword                |
| [reconFTW](https://github.com/six2dez/reconftw) ⭐ 8,032 \| 🐛 4 \| 🌐 Shell \| 📅 2026-08-27              | End-to-end recon automation chaining 50+ tools for subdomains, vulns, and OSINT       |
| [IntelOwl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,685 \| 🐛 76 \| 🌐 Python \| 📅 2026-08-26    | OSINT solution that aggregates 100+ analyzers (threat intel, malware, observables)    |
...
| [Carbon14](https://github.com/Lazza/Carbon14) ⭐ 126 \| 🐛 0 \| 🌐 Python \| 📅 2026-05-21                 | OSINT tool for estimating the age of web pages from HTTP metadata                     |
...
| [Malware Analysis - CSCI 4976](https://github.com/RPISEC/Malware/blob/master/README.md) ⭐ 4,064 \| 🐛 1 \| 📅 2022-08-26 | another class from the folks at RPISEC, quality content |
...
| Name                                                                                                                                                | Description                                                                                                                        |
| --------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| [Garak](https://github.com/leondz/garak) ⭐ 9,072 \| 🐛 410 \| 🌐 Python \| 📅 2026-08-25                                                            | Most mature open-source LLM vulnerability scanner. Probes for prompt injection, jailbreaks, data leakage, hallucination, toxicity. |
...
| [Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,664 \| 🐛 549 \| 🌐 TypeScript \| 📅 2026-08-29                                            | LLM red-team + eval framework with 100+ attack types.                                                                              |
| [DeepTeam](https://github.com/confident-ai/deepteam) ⭐ 2,637 \| 🐛 61 \| 🌐 Python \| 📅 2026-08-21                                                 | Red-team framework mapped to OWASP LLM Top 10; 50+ vulnerabilities, 20+ adversarial methods.                                       |
| [LLMFuzzer](https://github.com/mnns/LLMFuzzer) ⭐ 379 \| 🐛 3 \| 🌐 Python \| 📅 2024-02-12                                                          | Fuzzing framework specifically for LLM integrations.                                                                               |
| [promptmap](https://github.com/utkusen/promptmap) ⭐ 1,255 \| 🐛 4 \| 🌐 Python \| 📅 2025-12-01                                                     | Prompt-injection vulnerability scanner.                                                                                            |
| [Adversarial Robustness Toolbox (ART)](https://github.com/Trusted-AI/adversarial-robustness-toolbox) ⭐ 6,210 \| 🐛 20 \| 🌐 Python \| 📅 2025-12-12 | Linux Foundation library covering evasion, poisoning, extraction, and inference attacks across all major ML frameworks.            |
| [CleverHans](https://github.com/cleverhans-lab/cleverhans) ⭐ 6,450 \| 🐛 46 \| 🌐 Jupyter Notebook \| 📅 2024-04-10                                 | Classic library for crafting adversarial examples against image models.                                                            |
| [AI Exploits (Protect AI)](https://github.com/protectai/ai-exploits) ⭐ 1,747 \| 🐛 3 \| 🌐 Python \| 📅 2024-10-23                                  | Collection of real, working exploits for vulnerabilities found in AI/ML tools and platforms.                                       |
...
| [Indirect Prompt Injection (Greshake et al.)](https://github.com/greshake/llm-security) ⭐ 2,132 \| 🐛 1 \| 🌐 Jupyter Notebook \| 📅 2025-07-17 | Canonical research repo for indirect prompt injection.                                       |
...
| Name                                                                                                                          | Description                                                             |
| ----------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| [corca-ai/awesome-llm-security](https://github.com/corca-ai/awesome-llm-security) ⭐ 1,688 \| 🐛 198 \| 📅 2025-08-20          | Most-starred LLM security awesome list.                                 |
| [PromptLabs/Prompt-Hacking-Resources](https://github.com/PromptLabs/Prompt-Hacking-Resources) ⭐ 692 \| 🐛 2 \| 📅 2026-07-30  | Focused specifically on red teaming, jailbreaks, prompt injection.      |
| [jiep/offensive-ai-compilation](https://github.com/jiep/offensive-ai-compilation) ⭐ 1,418 \| 🐛 7 \| 🌐 HTML \| 📅 2026-08-01 | Offense-oriented curation: AI-powered attacks, plus attacks against AI. |
...
| [Damn Small Vulnerable Web](https://github.com/stamparm/DSVW) ⭐ 880 \| 🐛 1 \| 🌐 Python \| 📅 2026-08-19                                 | written in less than 100 lines of code, this web app has tons of vulns, great for teaching |
...
| [OWASP Juice Shop](https://github.com/juice-shop/juice-shop) ⭐ 13,740 \| 🐛 9 \| 🌐 TypeScript \| 📅 2026-08-28                           | covers the OWASP top 10 vulns                                                              |
| [WebGoat: A deliberately insecure Web Application](https://github.com/WebGoat/WebGoat) ⭐ 9,307 \| 🐛 39 \| 🌐 JavaScript \| 📅 2026-08-24 | maintained by OWASP and designed to to teach web app security                              |
...
| [Metasploitable3](https://github.com/rapid7/metasploitable3) ⭐ 5,689 \| 🐛 74 \| 🌐 HTML \| 📅 2025-02-13 \[[Installation](https://github.com/rapid7/metasploitable3/blob/master/README.md) ⭐ 5,689 \| 🐛 74 \| 🌐 HTML \| 📅 2025-02-13] | the third installation of this vulnerable OS                 |
...
| [Docker for pentest](https://github.com/aaaguirrep/pentest) ⭐ 770 \| 🐛 3 \| 🌐 Dockerfile \| 📅 2022-03-11 | Image with the more used tools to create a pentest environment easily and quickly. |
